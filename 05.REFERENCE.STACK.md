...
published in `README.md` and projected into `artifacts/bindings.json`, while transcript dependency
scope is publishing through `artifacts/bytes.json`. Cross-implementation replay of the maintained
